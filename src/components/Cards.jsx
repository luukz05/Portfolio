        ...
        <div className="flex gap-3 mt-auto w-full justify-center">
          ...
          {link ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-ch1 text-ch4 font-bold py-2 px-4 rounded-xl hover:bg-ch3 transition w-full inline-flex items-center justify-center gap-2"
            >
              <img src="src/assets/resize.png" className=" h-6" />{" "}
              <p>Acessar página</p>
            </a>
          ) : (
            <p
